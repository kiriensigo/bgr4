...
# 英語説明文があるゲームを取得
games_with_description = Game.where.not(description: nil)
total_count = games_with_description.count
...
games_with_description.each_with_index do |game, index|
  ...
  begin
    ...
    if cleaned_description != original_description
      game.update(description: cleaned_description)
      puts "  ✓ クリーンアップ完了"
